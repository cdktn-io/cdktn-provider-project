...
export interface ShouldReleaseScriptFileOptions extends FileBaseOptions {}

export class ShouldReleaseScriptFile extends FileBase {
  protected readonly options: ShouldReleaseScriptFileOptions;

  constructor(project: NodeProject, options: ShouldReleaseScriptFileOptions) {

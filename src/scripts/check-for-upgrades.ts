...
export class CheckForUpgradesScriptFile extends FileBase {
  protected readonly options: CheckForUpgradesScriptFileOptions;

  constructor(
    project: NodeProject,
    options: CheckForUpgradesScriptFileOptions
  ) {
...
const CONSTRAINT = "${providerVersion}";
const FQ_PROVIDER_NAME = "${fqproviderName}";
